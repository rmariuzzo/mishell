...
exports.runIfFileExist = void 0;
var execa_1 = __importDefault(require("execa"));
var fs_1 = __importDefault(require("fs"));
var path_1 = __importDefault(require("path"));
var util_1 = require("util");
var access = util_1.promisify(fs_1.default.access);
var runIfFileExist = function (args, opts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Promise.all(files.map(function (file) { return access(path_1.default.join(opts.cwd, file)); }))];
            case 2:
                _c.sent();
                return [3 /*break*/, 4];
            case 3:
...
exports.runIfFileExist = runIfFileExist;
